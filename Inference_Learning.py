...
# Create optimizer
optim_1 = optim.SGD(NCNet.LPU_1.parameters(), lr=0.1, momentum=0.90, weight_decay=0.00001, nesterov=True)
optim_2 = optim.SGD(NCNet.LPU_2.parameters(), lr=0.1, momentum=0.90, weight_decay=0.00001, nesterov=True)
optim_3 = optim.SGD(NCNet.LPU_3.parameters(), lr=0.1, momentum=0.90, weight_decay=0.00001, nesterov=True)
optim_4 = optim.SGD(NCNet.LPU_4.parameters(), lr=0.1, momentum=0.90, weight_decay=0.00001, nesterov=True)
optim_5 = optim.SGD(NCNet.LPU_5.parameters(), lr=0.1, momentum=0.90, weight_decay=0.00001, nesterov=True)
...
for i in range(0,3):
    ...
    a = list(NCNet.LPU_1.parameters())[0].clone()
    ...
    b = list(NCNet.LPU_1.parameters())[0].clone()
