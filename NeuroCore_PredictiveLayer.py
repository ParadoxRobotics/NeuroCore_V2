        ...
        if len(upperHiddenSize) == len(upperHiddenSize) == len(upperHiddenChannels):
            ...
            if self.numberFeedback != 0:
                ...
                for i in range(self.numberFeedback):
                    ...
                    print("encoder feedback",i+1,"nb weights =",len(self.WFeedbackIdx[i]))
